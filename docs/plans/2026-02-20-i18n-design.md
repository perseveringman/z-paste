# Z-Paste i18n Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add internationalization support for zh-CN, en, and zh-TW to the Z-Paste Electron clipboard manager app.
...
```json
{
  ...
  "settings.general.launchAtLogin.desc": "登录 macOS 时自动启动 Z-Paste",
  ...
  "onboarding.step1.title": "欢迎使用 Z-Paste",
  ...
  "onboarding.step2.description": "用一个快捷键唤起 Z-Paste",
  ...
  "onboarding.step4.description": "开始使用 Z-Paste 提升你的效率",
...
```json
{
  ...
  "settings.general.launchAtLogin.desc": "Automatically start Z-Paste when logging into macOS",
  ...
  "onboarding.step1.title": "Welcome to Z-Paste",
  ...
  "onboarding.step2.description": "Summon Z-Paste with a single shortcut",
  ...
  "onboarding.step4.description": "Start using Z-Paste to boost your productivity",
  "onboarding.step4.ready": "Everything is ready!",
  "onboarding.step4.hint": "After copying anything, press ⇧⌘V to start using Z-Paste",
...
```json
{
  ...
  "settings.general.launchAtLogin.desc": "登入 macOS 時自動啟動 Z-Paste",
  ...
  "onboarding.step1.title": "歡迎使用 Z-Paste",
  ...
  "onboarding.step2.description": "用一個快捷鍵喚起 Z-Paste",
  ...
  "onboarding.step4.description": "開始使用 Z-Paste 提升你的效率",
