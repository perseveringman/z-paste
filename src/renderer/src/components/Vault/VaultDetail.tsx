                ...
                <div className="max-w-2xl mx-auto space-y-8">
                  {detail.type === 'login' && (
                    <div className="grid grid-cols-1 gap-6">
                          ...
                          <div className="p-4 flex items-center justify-between border-b border-muted/30 group">
                            <div className="min-w-0">
                              ...
                              <p className="font-medium text-sm truncate">
                                {'username' in detail.fields ? detail.fields.username : ''}
                              </p>
                            </div>
                            <Button 
                              variant="ghost" 
                              ...
                              onClick={() => handleCopy('username' in detail.fields ? detail.fields.username : '', 'username')}
                            >
                          ...
                          <div className="p-4 flex items-center justify-between group">
                            <div className="min-w-0">
                              ...
                              <p className="font-mono text-sm truncate tracking-wider">
                                {showPassword 
                                  ? ('password' in detail.fields ? detail.fields.password : '') 
                                  : '••••••••••••'}
                              </p>
                            </div>
                            <div className="flex items-center gap-1">
                              ...
                              <Button 
                                ...
                                onClick={() => handleCopy('password' in detail.fields ? detail.fields.password : '', 'password')}
                              >
                      ...
                      {/* TOTP Section */}
                      {detail.type === 'login' && 'totpSecret' in detail.fields && detail.fields.totpSecret && (
                      ...
                      {/* Notes Section */}
                      {detail.type === 'login' && 'notes' in detail.fields && detail.fields.notes && (
                        <div className="space-y-3">
                          <div className="flex items-center justify-between px-1">
                            ...
                            <Button 
                              ...
                              onClick={() => handleCopy('notes' in detail.fields ? (detail.fields.notes || '') : '', 'notes')}
                            >
                  ...
                  {detail.type === 'secure_note' && 'content' in detail.fields && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between px-1">
                        ...
                        <Button 
                          ...
                          size="sm" 
                          className="h-6 text-[10px] px-2 text-muted-foreground"
                          onClick={() => handleCopy('content' in detail.fields ? detail.fields.content : '', 'note')}
                        >
